...
export default function FriendItem({ item, friendsPessHandler, acceptPessHandler, removeFriend, addFrendPressHandler, pendingPessHandler }) {
  console.log(item.name);
  console.log(item.friend_status);
  console.log(" action user" + item.action_user);

  if (item.friend_status == 2){ //they are both friends
    return (
          <LinearGradient
